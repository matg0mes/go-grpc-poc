...
type CategoryServiceClient interface {
	...
	CreateCategoryStreamBidiretional(ctx context.Context, opts ...grpc.CallOption) (CategoryService_CreateCategoryStreamBidiretionalClient, error)
...
func (c *categoryServiceClient) CreateCategoryStreamBidiretional(ctx context.Context, opts ...grpc.CallOption) (CategoryService_CreateCategoryStreamBidiretionalClient, error) {
	stream, err := c.cc.NewStream(ctx, &CategoryService_ServiceDesc.Streams[1], "/pb.CategoryService/CreateCategoryStreamBidiretional", opts...)
	if err != nil {
		return nil, err
	}
	x := &categoryServiceCreateCategoryStreamBidiretionalClient{stream}
	return x, nil
}

type CategoryService_CreateCategoryStreamBidiretionalClient interface {
	Send(*CreateCategoryRequest) error
	Recv() (*Category, error)
	grpc.ClientStream
}

type categoryServiceCreateCategoryStreamBidiretionalClient struct {
	grpc.ClientStream
}

func (x *categoryServiceCreateCategoryStreamBidiretionalClient) Send(m *CreateCategoryRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *categoryServiceCreateCategoryStreamBidiretionalClient) Recv() (*Category, error) {
	m := new(Category)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type CategoryServiceServer interface {
	...
	CreateCategoryStreamBidiretional(CategoryService_CreateCategoryStreamBidiretionalServer) error
...
func (UnimplementedCategoryServiceServer) CreateCategoryStreamBidiretional(CategoryService_CreateCategoryStreamBidiretionalServer) error {
	return status.Errorf(codes.Unimplemented, "method CreateCategoryStreamBidiretional not implemented")
}
...
func _CategoryService_CreateCategoryStreamBidiretional_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(CategoryServiceServer).CreateCategoryStreamBidiretional(&categoryServiceCreateCategoryStreamBidiretionalServer{stream})
}

type CategoryService_CreateCategoryStreamBidiretionalServer interface {
	Send(*Category) error
	Recv() (*CreateCategoryRequest, error)
	grpc.ServerStream
}

type categoryServiceCreateCategoryStreamBidiretionalServer struct {
	grpc.ServerStream
}

func (x *categoryServiceCreateCategoryStreamBidiretionalServer) Send(m *Category) error {
	return x.ServerStream.SendMsg(m)
}

func (x *categoryServiceCreateCategoryStreamBidiretionalServer) Recv() (*CreateCategoryRequest, error) {
	m := new(CreateCategoryRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var CategoryService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "CreateCategoryStreamBidiretional",
			Handler:       _CategoryService_CreateCategoryStreamBidiretional_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
