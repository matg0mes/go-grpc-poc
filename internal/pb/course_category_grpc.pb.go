...
type CategoryServiceClient interface {
	CreateCategory(ctx context.Context, in *CreateCategoryResponse, opts ...grpc.CallOption) (*Category, error)
...
func (c *categoryServiceClient) CreateCategory(ctx context.Context, in *CreateCategoryResponse, opts ...grpc.CallOption) (*Category, error) {
	out := new(Category)
...
type CategoryServiceServer interface {
	CreateCategory(context.Context, *CreateCategoryResponse) (*Category, error)
...
func (UnimplementedCategoryServiceServer) CreateCategory(context.Context, *CreateCategoryResponse) (*Category, error) {
